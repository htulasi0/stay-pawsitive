            ...
            <div id="content-wrap">
                ...
                <main>
                    <form action="order.html" method="POST">
                        ...
                        <input type="hidden" name="productName" value="Grain-Free Dog Food">
                        <input type="hidden" name="productImage" value="productsml.png">
                        <h1>
                            Grain-Free Dog Food
                            <span class="stars">&#9733; &#9733; &#9733; &#9733; &#9733;</span>
                        </h1>
                        <img src="images/productbg.png" alt="Grain-Free Dog Food">
                        ...
                        <p>Guaranteed Analysis: Crude protein (min) 26%, crude fat (min) 13%, crude fiber (max) 4.5%, moisture
                            (max) 12%.</p>
                        <p>Why we like it: This dog food option is great because it is clean and natural. The first ingredient
                            in this dog food is always a high quality protein, their food is grain-free for easy digestion, has
                            a poultry-free recipe, and is made locally with great ingredients. More importantly, we like 
                            <em><strong>Stay Pawsitive</strong></em> dog food because it aids better health for dogs, especially 
                            with their coat and skin.</p>
