        ...
        <div id="page-container">
            <div id="content-wrap">
                ...
                <main>
                    ...
                    <div class="text-section" id="faq">
                        <div class="faq1">
                            <h3>Are your products really safe for my pet?</h3>
                            <p>All of our products are certified to be safe for your pets by the Center for Pet Safety, or CPS. Each product is not only "crash tested" but is also free of anything that may be harmful to you, your pets, or the environment.
                            </p>
                        </div>
                        <hr>
                        <div>
                            <h3>What should I do if I haven't received my order?</h3>
                            <p>All orders come with a tracking number so you can see where your order is on its route to you. If the tracking number lists the order as "Delivered" but you have not received it, contact support at support@staypawsitive.org so we can resolve the issue.
                            </p>
                        </div>
                        <hr>
                        <div>
                        ...
                        <div>
                            ...
                            <p>Return any product for any reason within 60 days of receipt for a refund equal to the amount paid for the product (not including shipping charges). The refund will be issued back to the original method of payment.
                            </p>
                        </div>
                        <hr>
                        <div>
                        ...
                        <hr>
                        <div>
                            <h3>Can I make a donation in memory of a beloved pet?</h3>
                            <p>Yes you can! On the donation page﻿ under the option to make a one-time or monthly gift, add your pet's name and a short note if you'd like.
                            </p>
                        </div>
                        <hr>
                        <div>
